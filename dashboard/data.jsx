...
const BOTS = [
  {
    id: 'polyedge', name: 'ProfitWeather V1.0', market: 'polymarket', glyph: '🌦',
  ...
  {
    id: 'wellington', name: 'Wellington Temp', market: 'polymarket', glyph: '🌊', flag: '🇳🇿',
    type: 'temperature', citySlug: 'wellington',
    strategy: 'Température max Wellington 75%+', venue: 'Polymarket',
    status: 'running', capital: 0, allocPct: 0,
    pnlDayPct: 0, pnlDayAbs: 0, pnlTotalPct: 0, pnlTotalAbs: 0,
    winRate: 0, sharpe: 0, maxDD: 0, trades: 0, openPos: 0,
    series: Array(90).fill(0),
  ...
  {
    id: 'chongqing', name: 'Chongqing Temp', market: 'polymarket', glyph: '🏙️', flag: '🇨🇳',
    type: 'temperature', citySlug: 'chongqing',
    strategy: 'Température max Chongqing 75%+', venue: 'Polymarket',
    status: 'running', capital: 0, allocPct: 0,
    pnlDayPct: 0, pnlDayAbs: 0, pnlTotalPct: 0, pnlTotalAbs: 0,
    winRate: 0, sharpe: 0, maxDD: 0, trades: 0, openPos: 0,
    series: Array(90).fill(0),
  ...
  {
    id: 'wuhan', name: 'Wuhan Temp', market: 'polymarket', glyph: '🌉', flag: '🇨🇳',
    type: 'temperature', citySlug: 'wuhan',
    strategy: 'Température max Wuhan 75%+', venue: 'Polymarket',
    status: 'running', capital: 0, allocPct: 0,
    pnlDayPct: 0, pnlDayAbs: 0, pnlTotalPct: 0, pnlTotalAbs: 0,
    winRate: 0, sharpe: 0, maxDD: 0, trades: 0, openPos: 0,
    series: Array(90).fill(0),
  ...
  {
    id: 'ankara', name: 'Ankara Temp', market: 'polymarket', glyph: '🕌', flag: '🇹🇷',
    type: 'temperature', citySlug: 'ankara',
    strategy: 'Température max Ankara 75%+', venue: 'Polymarket',
    status: 'running', capital: 0, allocPct: 0,
    pnlDayPct: 0, pnlDayAbs: 0, pnlTotalPct: 0, pnlTotalAbs: 0,
    winRate: 0, sharpe: 0, maxDD: 0, trades: 0, openPos: 0,
    series: Array(90).fill(0),
  ...
  {
    id: 'moscow', name: 'Moscou Temp', market: 'polymarket', glyph: '❄️', flag: '🇷🇺',
    type: 'temperature', citySlug: 'moscow',
    strategy: 'Température max Moscou 75%+', venue: 'Polymarket',
    status: 'running', capital: 0, allocPct: 0,
    pnlDayPct: 0, pnlDayAbs: 0, pnlTotalPct: 0, pnlTotalAbs: 0,
    winRate: 0, sharpe: 0, maxDD: 0, trades: 0, openPos: 0,
    series: Array(90).fill(0),
  ...
  {
    id: 'lucknow', name: 'Lucknow Temp', market: 'polymarket', glyph: '🕌', flag: '🇮🇳',
    type: 'temperature', citySlug: 'lucknow',
    strategy: 'Température max Lucknow 75%+', venue: 'Polymarket',
    status: 'running', capital: 0, allocPct: 0,
    pnlDayPct: 0, pnlDayAbs: 0, pnlTotalPct: 0, pnlTotalAbs: 0,
    winRate: 0, sharpe: 0, maxDD: 0, trades: 0, openPos: 0,
    series: Array(90).fill(0),
  ...
  {
    id: 'istanbul', name: 'Istanbul Temp', market: 'polymarket', glyph: '🌉', flag: '🇹🇷',
    type: 'temperature', citySlug: 'istanbul',
    strategy: 'Température max Istanbul 75%+', venue: 'Polymarket',
    status: 'running', capital: 0, allocPct: 0,
    pnlDayPct: 0, pnlDayAbs: 0, pnlTotalPct: 0, pnlTotalAbs: 0,
    winRate: 0, sharpe: 0, maxDD: 0, trades: 0, openPos: 0,
    series: Array(90).fill(0),
  ...
  {
    id: 'warsaw', name: 'Varsovie Temp', market: 'polymarket', glyph: '🏰', flag: '🇵🇱',
    type: 'temperature', citySlug: 'warsaw',
    strategy: 'Température max Varsovie 75%+', venue: 'Polymarket',
    status: 'running', capital: 0, allocPct: 0,
    pnlDayPct: 0, pnlDayAbs: 0, pnlTotalPct: 0, pnlTotalAbs: 0,
    winRate: 0, sharpe: 0, maxDD: 0, trades: 0, openPos: 0,
    series: Array(90).fill(0),
  ...
  {
    id: 'milan', name: 'Milan Temp', market: 'polymarket', glyph: '🏛️', flag: '🇮🇹',
    type: 'temperature', citySlug: 'milan',
    strategy: 'Température max Milan 75%+', venue: 'Polymarket',
    status: 'running', capital: 0, allocPct: 0,
    pnlDayPct: 0, pnlDayAbs: 0, pnlTotalPct: 0, pnlTotalAbs: 0,
    winRate: 0, sharpe: 0, maxDD: 0, trades: 0, openPos: 0,
    series: Array(90).fill(0),
  ...
  {
    id: 'helsinki', name: 'Helsinki Temp', market: 'polymarket', glyph: '🌲', flag: '🇫🇮',
    type: 'temperature', citySlug: 'helsinki',
    strategy: 'Température max Helsinki 75%+', venue: 'Polymarket',
    status: 'running', capital: 0, allocPct: 0,
    pnlDayPct: 0, pnlDayAbs: 0, pnlTotalPct: 0, pnlTotalAbs: 0,
    winRate: 0, sharpe: 0, maxDD: 0, trades: 0, openPos: 0,
    series: Array(90).fill(0),
  ...
  {
    id: 'karachi', name: 'Karachi Temp', market: 'polymarket', glyph: '🌊', flag: '🇵🇰',
    type: 'temperature', citySlug: 'karachi',
    strategy: 'Température max Karachi 75%+', venue: 'Polymarket',
    status: 'running', capital: 0, allocPct: 0,
    pnlDayPct: 0, pnlDayAbs: 0, pnlTotalPct: 0, pnlTotalAbs: 0,
    winRate: 0, sharpe: 0, maxDD: 0, trades: 0, openPos: 0,
    series: Array(90).fill(0),
  ...
  {
    id: 'cape_town', name: 'Cape Town Temp', market: 'polymarket', glyph: '⛰️', flag: '🇿🇦',
    type: 'temperature', citySlug: 'cape-town',
    strategy: 'Température max Cape Town 75%+', venue: 'Polymarket',
    status: 'running', capital: 0, allocPct: 0,
    pnlDayPct: 0, pnlDayAbs: 0, pnlTotalPct: 0, pnlTotalAbs: 0,
    winRate: 0, sharpe: 0, maxDD: 0, trades: 0, openPos: 0,
    series: Array(90).fill(0),
  ...
  {
    id: 'jeddah', name: 'Jeddah Temp', market: 'polymarket', glyph: '🕌', flag: '🇸🇦',
    type: 'temperature', citySlug: 'jeddah',
    strategy: 'Température max Jeddah 75%+', venue: 'Polymarket',
    status: 'running', capital: 0, allocPct: 0,
    pnlDayPct: 0, pnlDayAbs: 0, pnlTotalPct: 0, pnlTotalAbs: 0,
    winRate: 0, sharpe: 0, maxDD: 0, trades: 0, openPos: 0,
    series: Array(90).fill(0),
  ...
  {
    id: 'shenzhen', name: 'Shenzhen Temp', market: 'polymarket', glyph: '🏗️', flag: '🇨🇳',
    type: 'temperature', citySlug: 'shenzhen',
    strategy: 'Température max Shenzhen 75%+', venue: 'Polymarket',
    status: 'running', capital: 0, allocPct: 0,
    pnlDayPct: 0, pnlDayAbs: 0, pnlTotalPct: 0, pnlTotalAbs: 0,
    winRate: 0, sharpe: 0, maxDD: 0, trades: 0, openPos: 0,
    series: Array(90).fill(0),
  ...
  {
    id: 'busan', name: 'Busan Temp', market: 'polymarket', glyph: '⚓', flag: '🇰🇷',
    type: 'temperature', citySlug: 'busan',
    strategy: 'Température max Busan 75%+', venue: 'Polymarket',
    status: 'running', capital: 0, allocPct: 0,
    pnlDayPct: 0, pnlDayAbs: 0, pnlTotalPct: 0, pnlTotalAbs: 0,
    winRate: 0, sharpe: 0, maxDD: 0, trades: 0, openPos: 0,
    series: Array(90).fill(0),
  ...
  {
    id: 'qingdao', name: 'Qingdao Temp', market: 'polymarket', glyph: '⛵', flag: '🇨🇳',
    type: 'temperature', citySlug: 'qingdao',
    strategy: 'Température max Qingdao 75%+', venue: 'Polymarket',
    status: 'running', capital: 0, allocPct: 0,
    pnlDayPct: 0, pnlDayAbs: 0, pnlTotalPct: 0, pnlTotalAbs: 0,
    winRate: 0, sharpe: 0, maxDD: 0, trades: 0, openPos: 0,
    series: Array(90).fill(0),
  ...
  {
    id: 'kuala_lumpur', name: 'Kuala Lumpur Temp', market: 'polymarket', glyph: '🏙️', flag: '🇲🇾',
    type: 'temperature', citySlug: 'kuala-lumpur',
    strategy: 'Température max Kuala Lumpur 75%+', venue: 'Polymarket',
    status: 'running', capital: 0, allocPct: 0,
    pnlDayPct: 0, pnlDayAbs: 0, pnlTotalPct: 0, pnlTotalAbs: 0,
    winRate: 0, sharpe: 0, maxDD: 0, trades: 0, openPos: 0,
    series: Array(90).fill(0),
