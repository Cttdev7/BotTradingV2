...
_WEATHER_VILLES = [
    ...
    {'slug': 'los-angeles',   'tz': 'America/Los_Angeles'},
    {'slug': 'guangzhou',     'tz': 'Asia/Shanghai'},
    {'slug': 'mexico-city',   'tz': 'America/Mexico_City'},
    {'slug': 'amsterdam',     'tz': 'Europe/Amsterdam'},
    {'slug': 'paris',         'tz': 'Europe/Paris'},
    {'slug': 'toronto',       'tz': 'America/Toronto'},
    {'slug': 'chicago',       'tz': 'America/Chicago'},
    {'slug': 'denver',        'tz': 'America/Denver'},
    {'slug': 'houston',       'tz': 'America/Chicago'},
    {'slug': 'taipei',        'tz': 'Asia/Taipei'},
    {'slug': 'beijing',       'tz': 'Asia/Shanghai'},
    {'slug': 'san-francisco', 'tz': 'America/Los_Angeles'},
    {'slug': 'dallas',        'tz': 'America/Chicago'},
    {'slug': 'wellington',    'tz': 'Pacific/Auckland'},
    {'slug': 'chongqing',     'tz': 'Asia/Shanghai'},
    {'slug': 'wuhan',         'tz': 'Asia/Shanghai'},
    {'slug': 'ankara',        'tz': 'Europe/Istanbul'},
    {'slug': 'moscow',        'tz': 'Europe/Moscow'},
    {'slug': 'lucknow',       'tz': 'Asia/Kolkata'},
    {'slug': 'istanbul',      'tz': 'Europe/Istanbul'},
    {'slug': 'warsaw',        'tz': 'Europe/Warsaw'},
    {'slug': 'milan',         'tz': 'Europe/Rome'},
    {'slug': 'helsinki',      'tz': 'Europe/Helsinki'},
    {'slug': 'karachi',       'tz': 'Asia/Karachi'},
    {'slug': 'cape-town',     'tz': 'Africa/Johannesburg'},
    {'slug': 'jeddah',        'tz': 'Asia/Riyadh'},
    {'slug': 'shenzhen',      'tz': 'Asia/Shanghai'},
    {'slug': 'busan',         'tz': 'Asia/Seoul'},
    {'slug': 'qingdao',       'tz': 'Asia/Shanghai'},
    {'slug': 'kuala-lumpur',  'tz': 'Asia/Kuala_Lumpur'},
    {'slug': 'tel-aviv',      'tz': 'Asia/Jerusalem'},
    {'slug': 'manila',        'tz': 'Asia/Manila'},
    {'slug': 'munich',        'tz': 'Europe/Berlin'},
]
            ...
            try:
                ...
                for m in event.get("markets", []):
                    ...
                    result.append({
                        ...
                        "tokens":       tokens,
                        "day_offset":   delta,
                        "end_date_iso": m.get("endDate") or m.get("endDateIso") or "",
                    })
                    seen.add(cid)
                    found_open = True
